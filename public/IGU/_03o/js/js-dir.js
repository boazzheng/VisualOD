...
switch(file.type) {
  case 'application/pdf':
    var decodificador = 'embed';
    //console.log('é pdf', decodificador);
    break;
  case 'image/jpeg':
    var decodificador = 'img';
    //console.log('é imagem', decodificador);
    break;
  default:
    console.log('sei lá', decodificador);
}


      thumbnails.innerHTML = '<h3>Carregando...</h3>';
